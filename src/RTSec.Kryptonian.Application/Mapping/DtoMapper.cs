...
internal static class DtoMapper
{
    ...
    public static DeviceDto ToDto(Device entity)
    {
        return new DeviceDto
        {
            ...
            HasActivationCode = entity.ActivationCodeHash != null && entity.ActivationCodeUsedAt == null,
            ActivationCodeExpiresAt = entity.ActivationCodeExpiresAt,
            ActivationCodeUsedAt = entity.ActivationCodeUsedAt,
